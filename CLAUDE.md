...
| Next task | **TRAIN-001** chạy `notebooks/TRAIN_001_colab_kaggle.ipynb` trên Colab/Kaggle khi có GPU quota (full fine-tune 9207 samples VietMed, nhiều epoch) hoặc pilot audio · CT-049 re-test · CT-019 debug A2-VAD nếu có audio · các PA UI test khác |
